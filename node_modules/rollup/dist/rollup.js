/*
	Rollup.js v0.26.0
	Fri Apr 22 2016 16:22:13 GMT-0400 (EDT) - commit 004f5a1d69620652aa66815987cd30bf97a78657
			...
			return _this4.resolveId(source, module.id).then(function (resolvedId) {
				...
				if (!resolvedId || forcedExternal) {
					...
					if (!forcedExternal) {
						...
						normalizedExternal = _this4.getPathRelativeToEntryDirname(resolvedId);
					}
					module.resolvedIds[source] = normalizedExternal;

					if (!_this4.moduleById[normalizedExternal]) {
						var _module = new ExternalModule(normalizedExternal);
						_this4.externalModules.push(_module);
						_this4.moduleById[normalizedExternal] = _module;
					}
				} else {
...
var ALLOWED_KEYS = ['banner', 'dest', 'entry', 'exports', 'external', 'footer', 'format', 'globals', 'indent', 'intro', 'moduleId', 'moduleName', 'noConflict', 'onwarn', 'outro', 'plugins', 'sourceMap', 'useStrict'];
